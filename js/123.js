...
parallaxWrapper.addEventListener('mousemove', (e) => {
    ...
    document.querySelector(
        '#parallax_3'
    ).style.transform = calcTransform(horizontal, vertical, 0)

    document.querySelector(
        '#parallax_2'
    ).style.transform = calcTransform(horizontal, vertical, 3)

    document.querySelector(
        '#parallax_1'
    ).style.transform = calcTransform(horizontal, vertical, 8)
})
